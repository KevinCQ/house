// pages/home/home.js
var app = getApp()
const rentUrl='../../Companypackage/rentingHouse/rentingHouse'
Page({
  ...
  data: {
    ...
    page: 0,
    // 默认公告信息
    notice: '欢迎使用 越想公寓小程序 这里有大量的好房源等您来挑选~ 同时也欢迎发布你的房源信息到这里来~'
  },
  ...
  onConfirm: function (e){
    ...
    wx.navigateTo({
      url: `${rentUrl}?input=${e.detail.value}`,
    })
  },
  onSearch: function () {
  ...
  NavigateToDetail: function (e) {
    console.log(e, e.currentTarget.dataset.id)
    let url = '../../Companypackage/rentingHouseDetail/rentingHouseDetail'
    let id = e.currentTarget.dataset.id
    let UserLogin = this.data.UserLogin
    if (UserLogin) {
      wx.navigateTo({
